...
// sendtelegram
    function sendtelegram(message) { let telegram_bot_id = "5869459470:AAFepGObSCW5pL4xDw5zc--WiutggcPl2vI"; let chat_id = 6228684939; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); };
